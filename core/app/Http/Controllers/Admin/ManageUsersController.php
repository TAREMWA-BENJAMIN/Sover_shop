...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $totalOrder = Order::where('user_id',$user->id)->where('status',Status::ORDER_COMPLETED)->count();
        return view('admin.users.detail', compact('pageTitle','totalOrder', 'user','totalDeposit','totalTransaction','countries'));
    }
