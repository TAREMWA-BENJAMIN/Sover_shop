...
@section('content')
    <section class="account-section bg_img d-flex " style="background: url({{ frontendImage('auth', @$bgImage->data_values->image, '1920x1280') }}) right;">
        <div class="account-wrapper">
            ...
            <h4 class="title mb-5">@lang('Sign Up Your Account')</h4>
            <form class="account-form @if (!gs('registration')) form-disabled @endif" action="{{ route('user.register') }}" method="POST">
                @csrf
                @if (!gs('registration'))
                    <span class="form-disabled-text">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80"
                            ...
                            <g>
                                <path
                                    ...
                                    fill="rgb(0 0 0 / 60%)" opacity="1" data-original="rgb(0 0 0 / 60%)" class="">
                                </path>
                                <path
                ...
                <div class="row">
                    ...
                    <div class="form--group col-sm-6">
                        ...
                        <input type="password" class="form-control form--control @if (gs('secure_password')) secure-password @endif" name="password"
                            required>
                    </div>
                    <div class="form--group col-sm-6">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a role="button" class="btn btn-dark btn--sm" data-bs-dismiss="modal">@lang('Close')</a>
