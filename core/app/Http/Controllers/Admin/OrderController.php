...
class OrderController extends Controller
{
    ...
    public function submitOrder(Request $request)
    {
        ...
        if($request->payment == Status::PAYMENT_TYPE_CASH_ON_DELIVERY){
    ...
    public function cancelOrder(Request $request)
    {
        ...
        if($order->status == Status::ORDER_PROCESSING ||$order->status == Status::ORDER_COMPLETED || $order->pay_status == Status::PAY_PAID){
