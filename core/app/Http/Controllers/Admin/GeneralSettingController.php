...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        $request->validate([
            ...
            'hot_deal_discount'=> 'nullable|numeric|gte:-1',
            'shipping_charge_inside' => 'required|numeric|gte:-1',
            'shipping_charge_outside' => 'required|numeric|gte:-1',
            'city' => 'required',
        ]);
        ...
        $general->hot_deal_discount = $request->hot_deal_discount;
        $general->city = $request->city;
        $general->shipping_charge_inside = $request->shipping_charge_inside;
        $general->shipping_charge_outside = $request->shipping_charge_outside;
        $general->save();
